...
class RadarPlot:
    ...
    def __init__(self, data, start_time=None):
        ...
        if not self._start_time:
            self._start_time = datetime.now(tz=pytz.timezone('Asia/Tehran')) - relativedelta.relativedelta(hours=1)
    ...
    def make_plot(self):
        ...
        with plt.style.context('dark_background'):
            fig, axes = plt.subplots(num_plots, 1, figsize=(18, 1.3 * num_plots), squeeze=False)
